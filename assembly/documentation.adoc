...
*For people using the camera different from above refer to picture/instructions when screwing on the camera below*

[cols="a,a"]
|====
| image::camera_1.png[170,140] | First, screw two M2.5x10 bolts on top. Don't screw all the way down.
|====
...
[cols="a,a"]
|====
| image::camera_3.png[170,140] | Insert the M2.5x10 bolt. It's a very tight fit. As you screw down the bolt, pressure will be created to hold down the camera in place.
|====

[cols="a,a"]
|====
| image::camera_4.png[170,140] | Screw the remaining M2.5x10 bolt. 
|====
