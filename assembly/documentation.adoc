...
=== Step 5. Combine cover for camera
...
5.1 Screw two bolt to the upper side.
...
5.2 Screw two bolt to the lower side.
...
6.1 Push four sockets to the U2D2 Power Hub Board like as below.
...
6.2 Attach U2D2 to the sockets of the U2D2 Power Hub Board.



=== Step 7. Attaching U2D2 board to the base of Grechen head.
...
7.1 Screw four M2.5x10 to attach the board to base of the Grechen head like as below.
...
7.2 Connect cable from the motor of base to the U2D2 board.
...
7.3 Connect a dynamixel cable(small-large). small => motor of upper , large => U2D2 board
