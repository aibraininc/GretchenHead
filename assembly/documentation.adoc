...
|====
| *Base* | *Upper part*
| image::grechen_head_base.jpg[320,240] | image::grechen_head_upper.jpg[320,240]
|====
...
=== Step 4. Mount camera on ABGH5 and focus setting
...
==== Step 4.1 Mount camera on ABGH5
...
6.2.2 Connect cable from the motor of base to the U2D2 board.
...
6.2.3 Connect a dynamixel cable(small-large). small => motor of upper , large => U2D2 board
...
link:https://youtu.be/QlEY7Alr9UI[click here to watch the video tutorial]
