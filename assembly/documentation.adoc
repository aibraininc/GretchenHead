...
3.1 Plug cable between two motors like as below an image.
...
3.2 Screw two M2.5x10 bolts for assembling the motor on ABGH4 as below an image.
...
|====
| *Before* | *After*
| image:mount_camera_before.jpg[320,240]| image:mount_camera_after.jpg[320,240]
|====
...
[cols="a,a"]
|====
2+|  image::screw_camera.jpg[320,240]
|====
