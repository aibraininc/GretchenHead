...
[cols="a,a"]
|====
2+|  image::assemble_upper_part_after.jpg[320,240]
|====
...
6.1 Plug cable between two motors like as below an image.
...
6.2 Screw two M2.5x10 bolts for assembling the motor on ABGH4 as below an image.
