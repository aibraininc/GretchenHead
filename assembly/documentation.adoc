...
*Components* : 1x ABGH1, 1x motor, 2x M2.5x10, 1x Dynamixel cable(small-small), 1x Dynamixel cable(small-large) 
...
4.1.1 Attach the dynamixel cable(small-small) on right side of the servo motor and dynamixel cable(small-large) on left side.
...
4.1.2 Attach the motor into the ABGH1 3D printed part

4.1.3 Screw the bolt so that the motor is tightly attached to ABGH1
