...
image:tools.jpg[640,480,width=150%,scaledwidth=150%]
...
*When reading the instructions, you should enlarge the images.* You would want to left click on the image. A new tab will open up with an oversized image. You can right click on the over sized image and click "View Image."
...
1.1.3 Screw the M2.5x10 bolt so that the motor is tightly attached to ABGH1.

* Make sure you only use two M2.5x10 bolts to attach the motor
...
[cols="a,a"]
|====
| image::screw_abgh3_abgh4.jpg[170,140] | Make sure the holes for the bolts are aligned for both AGBH4 and ABGH3.
|====
...
[cols="a,a"]
|====
| image::connection_beween_motors.jpg[170,140] | .
|====
...
[cols="a,a"]
|====
2+| *Tools*: Allen key, screw driver
...
[cols="a,a"]
|====
| image::unscrew_upper_motor.jpg[170,140] | Click "Cheese - Preferences" in left-upper side menu.
|====
[cols="a,a"]
|====
| image::make_sure_direction_upper.jpg[170,140] | Click "Cheese - Preferences" in left-upper side menu.
|====
...
[cols="a,a"]
|====
| image::combine_abgh4_abgh5.jpeg[170,140] | Click "Cheese - Preferences" in left-upper side menu.
|====
...
[cols="a,a"]
|====
| image::screw_upper_side.jpg[170,140] | Click "Cheese - Preferences" in left-upper side menu.
|====
...
[cols="a,a"]
|====
| image::screw_lower_side.jpg[170,140] | Click "Cheese - Preferences" in left-upper side menu.
|====
