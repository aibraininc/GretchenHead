...
[cols="a,a"]
|====
| image::screw_camera.jpg[170,140] | If the hole is too big, you can use a longer bolt (M2 x15) and nut to hold them in place.
|====
2.3.3 Connect the camera to your PC through the USB cable

[cols="a,a"]
|====
| image::plug_usb_camera.jpg[170,140] | If the hole is too big, you can use a longer bolt (M2 x15) and nut to hold them in place.
|====

2.3.4 Open the "Cheese Webcam Booth" application on ubuntu
[cols="a,a"]
|====
| image::search_cheese.jpg[170,140] | If the hole is too big, you can use a longer bolt (M2 x15) and nut to hold them in place.
|====
...
[cols="a,a"]
|====
| image::cheese_preferences.jpg[170,140] | Click "Cheese - Preferences" in left-upper side menu.
|====
...
[cols="a,a"]
|====
| image::focus_left_right.jpg[170,140] | Click "Cheese - Preferences" in left-upper side menu.
|====
[cols="a,a"]
|====
| image::focus_before.jpg[170,140] | Click "Cheese - Preferences" in left-upper side menu.
|====
[cols="a,a"]
|====
| image::focus_after.jpg[170,140] | Click "Cheese - Preferences" in left-upper side menu.
|====
